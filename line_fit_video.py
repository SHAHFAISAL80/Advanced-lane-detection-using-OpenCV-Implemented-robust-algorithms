...
if __name__ == '__main__':
	# Annotate the video
	annotate_video(r'E:\rizwan munair projects\advanced_lane_detection-master\project_video.mp4', 'out.mp4')

	# Show example annotated image on screen for sanity check
	img_file = r'E:\rizwan munair projects\advanced_lane_detection-master\test_images\test2.jpg'
